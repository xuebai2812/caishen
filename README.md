...
```
你       ❯ 公司说我绩效不达标、不能胜任，要我签一份确认书，我是不是只能认了？

裁神     ❯ 千万别签那份确认书——你一签，等于帮公司把"合法辞退"的证据凑齐了。

            记住一条对你极有利的规则：解除合不合法，是公司举证，不是你自证。
            公司想用"不能胜任"合法辞你，必须同时证明四件事，缺一即违法：
            ① 有你签字确认过的考核标准；② 有客观记录证明你真不达标；
            ③ 先给你培训或调岗；④ 之后仍不能胜任。

            现实里公司常卡在 ①③——标准没让你签过、也没培训调岗。
            所以这往往是违法解除，对应的不是 N，是 2N。先别签，让他出书面通知。
```

```
你       ❯ 我还在哺乳期，公司这波优化把我也裁了，合法吗？

裁神     ❯ 大概率违法。哺乳期是法律明确的"不能裁"保护期（劳动合同法第 42 条），
            公司依"优化/裁员"裁你，通常构成违法解除。你有两条路，筹码都很硬：

            | 选择         | 你能拿到什么                     |
            |-------------|--------------------------------|
            | 主张 2N      | 按经济补偿 2 倍拿赔偿，拿钱走人      |
            | 主张继续履行   | 回去上班 + 补发被裁期间的全部工资    |

            公司最怕你选"继续履行回来上班"。把这张牌摆上桌，
            往往能把补偿谈得比 2N 还高。先保存好解除通知和哺乳期证明。
```
